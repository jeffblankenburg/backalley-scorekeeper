...
const SUIT_CLASS: Record<Suit, string> = {
  ...
  diamonds: 'text-blue-500 border-blue-300 dark:border-blue-700',
  clubs: 'text-emerald-500 border-emerald-300 dark:border-emerald-700',
      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-xs">
        {SUITS.map((s) => (
          <button
            ...
            className={[
              'h-24 rounded-2xl border-2 text-5xl flex items-center justify-center transition-all active:scale-95',
